...
The proof explains the following picture;
the marked geodesic segments have length $r$, and the black points are pairwise at distance $s(r)$.
\begin{figure}[ht!]
\centering\vskip-0mm
...
Suppose $z$ is the splitting point of $[px]$ and $[py]$, and let $b=|z-x|=|z-y_a|$.
