...
\begin{itemize}
\item \emph{Any all-set-homogeneous geodesic space with locally unique nonbifurcating geodesics is classical;} it was proved by Garrett Birkhoff \cite{birkhoff}.
...
$\eps\z<|x_i-x_j|_M<1$ for some fixed $\eps>0$ and all $i\ne j$.
...
Note that the claim implies that the condition on fingerprints in our theorem is necessary.
